...
const SAMPLE_COMIC = {
  ...
  title: "Git",
  safe_title: "Git",
  alt: "If that doesn't fix it, git.txt contains the phone number of a friend of mine who understands git. Just wait through a hierarchical menu, because it's about an alarm system but quickly press 4.",
